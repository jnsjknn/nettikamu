  ...
  return (
    <Document history={history}>
      ...
      <p>
        ...
        tärkeää tietoa yksityisyydestäsi. Jos seloste sisältää jotain sellaista,
        mitä et hyväksy, pyydämme sinua lopettamaan sivustomme käytön
        välittömästi. Tämä tietosuojaseloste pätee kaikkeen tietoon, joka
        sivustomme kautta kerätään.
      </p>
      ...
      <p>
        ...
        voidaksemme tarjota käyttäjillemme hakutoiminnon, jonka avulla he voivat
        etsiä ilmoituksia tiettyjen hakukriteerien perusteella.
      </p>
      <p>
        Käytämme jakamiesi ystävänhakuilmoitusten tekstiä, jotta voimme tarjota
        sinulle mahdollisuuden esitellä itsesi ja kertoa minkälaisia ystäviä
        sivustoltamme etsit.
      </p>
      <p>
      ...
      <p>
        ...
        lainsäädännön perusteella velvollisuutemme. Mitään tietoja ei luovuteta
      ...
      <p>
        ...
        kolmansien osapuolien sivustoille tai palveluihin. Emme voi valvoa mitä
        tietoja kolmansien osapuolien sivustot keräävät tai tai mitä he
        kyseisillä tiedoilla tekevät. Emme vastaa tiedoista, joita sivustollemme
        linkatut kolmannen osapuolen sivustot keräävät. Perehdy huolella
        kyseisten sivustojen omiin tietosuojaselosteisiin ja olla siihen
        liittyen yhteydessä suoraan heihin.
      </p>
      <h2>7. Kuinka pitkään säilytämme tietojasi?</h2>
      <p>
        Säilytämme tietojasi niin kauan kun olet sivustomme käyttäjä ellei laki
        velvoita meitä poistamaan tietoja. Voit poistaa käyttäjätunnuksesi
        profiilissasi, jolloin tiedot sinusta poistetaan.
      </p>
      ...
      <p>
        ...
        Viimeisimmät muutokset korostetaan erilaisella pohjavärillä ja muutosten
        voimaantulon päivämäärä merkataan tietosuojaselosteen otsikon alle.
        Pyrimme mahdollisuuksien mukaan ilmoittamaan merkittävistä muutoksista,
        mutta rohkaisemme sinua aika-ajoin silmäilemään tietosuojaselosteen läpi
        mahdollisten muutosten varalta.
      </p>
      <h2>11. Miten voit ottaa yhteyttä meihin tietosuojaasi liittyen?</h2>
      <p>
        Jos sinulla herää kysyttävää tai huomioita tähän selosteeseen liittyen,
        voit olla meihin yhteydessä sähköpostitse osoitteeseen
